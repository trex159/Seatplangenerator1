...
const students = [
    { id: 1, name: "Elias W.", shouldSitWith: [], shouldNotSitWith: [20, 23, 19] },
    { id: 2, name: "Elias S.", shouldSitWith: [], shouldNotSitWith: [7, 14] },
    { id: 3, name: "Michelle", shouldSitWith: [5, 10, 18], shouldNotSitWith: [] },
    { id: 4, name: "Lorenz", shouldSitWith: [], shouldNotSitWith: [1, 8, 15, 17, 23, 5] },
    { id: 5, name: "Aurora", shouldSitWith: [3, 10, 18], shouldNotSitWith: [] },
    { id: 6, name: "Elias H.", shouldSitWith: [], shouldNotSitWith: [19, 16] },
    { id: 7, name: "Arian", shouldSitWith: [], shouldNotSitWith: [23, 20, 19, 17, 12, 16, 2] },
    { id: 8, name: "Raphael", shouldSitWith: [], shouldNotSitWith: [17, 15, 4, 9] },
    { id: 9, name: "Johannes", shouldSitWith: [23], shouldNotSitWith: [] },
    { id: 10, name: "Julia", shouldSitWith: [3, 5, 18], shouldNotSitWith: [] },
    { id: 11, name: "Sean", shouldSitWith: [], shouldNotSitWith: [] },
    { id: 12, name: "Elias T.", shouldSitWith: [], shouldNotSitWith: [7, 2, 17] },
    { id: 13, name: "Titus", shouldSitWith: [], shouldNotSitWith: [23, 7, 14, 22] },
    { id: 14, name: "Andi", shouldSitWith: [], shouldNotSitWith: [21, 15] },
    { id: 15, name: "Max", shouldSitWith: [], shouldNotSitWith: [17, 4, 23, 7, 11, 1, 14, 16, 2, 18] },
    { id: 16, name: "Igor", shouldSitWith: [], shouldNotSitWith: [19, 6] },
    { id: 17, name: "Elias K.", shouldSitWith: [], shouldNotSitWith: [4, 8, 15, 1, 23] },
    { id: 18, name: "Layan", shouldSitWith: [10, 5, 3], shouldNotSitWith: [] },
    { id: 19, name: "Boris", shouldSitWith: [], shouldNotSitWith: [24, 8, 10] },
    { id: 20, name: "Dominik", shouldSitWith: [], shouldNotSitWith: [19, 16, 6, 7] },
    { id: 21, name: "Phillip", shouldSitWith: [22], shouldNotSitWith: [] },
    { id: 22, name: "Richard", shouldSitWith: [21], shouldNotSitWith: [13, 17, 19] },
